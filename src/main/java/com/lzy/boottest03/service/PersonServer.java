...
public class PersonServer {
    ...
    public void addAPerson(Person person) {
        personMapper.addAPerson(person);
    }

    public void deleteAPersonById(Integer id) {
        personMapper.deleteAPersonById(id);
    }

    public void updateAPersonById(Integer id, String stuName, String stuGender) {
        personMapper.updateAPersonById(id, stuName, stuGender);
    }
